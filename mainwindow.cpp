...
MainWindow::MainWindow(QWidget *parent)
    ...
    QObject::connect(race1, &Controller::sig_WorkFinish, this, [&] () {
    ...
    QObject::connect(race2, &Controller::sig_WorkFinish, this, [&] () {
    ...
    QObject::connect(concurRace1, &ExampleRace::sig_Finish, this, [&] () {
    ...
    QObject::connect(concurRace2, &ExampleRace::sig_Finish, this, [&] () {
...
void MainWindow::StartRace(void) {
    ...
    if(ui->rb_qtConcur->isChecked()) {
        ...
        QFuture<void> future1 = QtConcurrent::run([=] () {
            ...
            concurRace1->DoWork(&number, ui->rb_qtConcur->isChecked(), ui->sb_initNum->value());
        });
        QFuture<void> future2 = QtConcurrent::run([=] () {

            concurRace2->DoWork(&number, ui->rb_qtConcur->isChecked(), ui->sb_initNum->value());
        });
    }
    else {
